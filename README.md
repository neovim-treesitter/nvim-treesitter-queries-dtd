# nvim-treesitter-queries-dtd

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-dtd/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-dtd/actions/workflows/validate.yml)

Neovim tree-sitter queries for **dtd**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-dtd",
...
- [ ] Changes are scoped to `dtd` — do not include files for other languages
